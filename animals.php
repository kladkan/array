  ...
  foreach($all_animals as $continent => $animal) {
    foreach($animal  as  $key => $value) {
      ...
      if ($space !== false) {
        ...
        //вместо count надо подставить число животных с двумя словами, как вычислить пока не знаю
        //почему-то в новый массив записывается одно и тоже значение $value
